...
<div class="home">
   <div class="grid-container">
      ...
      <div class="image">
        <img src="images\home.jpg" alt="Home Rental">
      </div>
   </div>
</div>
   ...
   <section class="services">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <h3>buy house</h3>
            <p>Explore the opportunity to become a homeowner with our selection of available houses for sale in prime locations.</p>
         </div>

         <div class="box">
            <img src="images/icon-2.png" alt="">
            <h3>rent house</h3>
            <p>Find your ideal rental home from our diverse range of properties, offering comfort and convenience for your lifestyle.</p>
         </div>

         <div class="box">
            <img src="images/icon-3.png" alt="">
            <h3>sell house</h3>
            <p>Ready to sell your home? Let us help you connect with potential buyers and navigate the real estate market seamlessly.</p>
         </div>

         <div class="box">
            <img src="images/icon-4.png" alt="">
            <h3>flats and buildings</h3>
            <p>Discover our collection of apartments and buildings, offering a range of living options to suit your preferences and needs.</p>
         </div>

         <div class="box">
            <img src="images/icon-5.png" alt="">
            <h3>shops and malls</h3>
            <p>Explore our commercial properties, including shops and malls, ideal for businesses looking for prime retail spaces in bustling locations.</p>
         </div>

         <div class="box">
            <img src="images/icon-6.png" alt="">
            <h3>24/7 service</h3>
            <p>Enjoy the convenience of 24/7 services, ensuring your needs are met anytime, day or night, for a seamless rental experience.</p>
         </div>
