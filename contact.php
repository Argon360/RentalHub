...
<section class="faq" id="faq">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Contact our support team for booking cancellations.</p>
      </div>

      <div class="box">
         <h3><span>When will I get the possession?</span><i class="fas fa-angle-down"></i></h3>
         <p>Possession dates vary;check with the property owner or landlord</p>
      </div>

      <div class="box">
         <h3><span>Where can I pay the rent?</span><i class="fas fa-angle-down"></i></h3>
         <p>Payment instructions are provided by the property owner.</p>
      </div>

      <div class="box">
         <h3><span>How to contact with the buyers?</span><i class="fas fa-angle-down"></i></h3>
         <p>Use the contact details on the property listing or inquire through our messaging system.</p>
      </div>

      <div class="box">
         <h3><span>why my listing not showing up?</span><i class="fas fa-angle-down"></i></h3>
         <p>Review listing criteria;ensure it meets the requirements</p>
      </div>

      <div class="box">
         <h3><span>How to promote my listing?</span><i class="fas fa-angle-down"></i></h3>
         <p>Use featured listings, share on social media, and enhance property details.</p>
      </div>
